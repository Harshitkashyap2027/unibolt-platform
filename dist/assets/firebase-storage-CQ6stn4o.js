import{_ as Pe,C as Ce,r as se,S as Ie,F as ve,e as j,b as xe,c as De,g as Le,d as Be}from"./firebase-core-BFqPDSUV.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F(t,e,n){let s=e;return n==null&&(s=`https://${e}`),`${n}://${s}/v0${t}`}function me(t){const e=encodeURIComponent;let n="?";for(const s in t)if(t.hasOwnProperty(s)){const r=e(s)+"="+e(t[s]);n=n+r+"&"}return n=n.slice(0,-1),n}var N;(function(t){t[t.NO_ERROR=0]="NO_ERROR",t[t.NETWORK_ERROR=1]="NETWORK_ERROR",t[t.ABORT=2]="ABORT"})(N||(N={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ne="storage";function Zt(t,e,n){return t=j(t),Ft(t,e,n)}function Yt(t){return t=j(t),qt(t)}function Jt(t,e){return t=j(t),jt(t,e)}function Qt(t=Le(),e){t=j(t);const s=xe(t,Ne).getImmediate({identifier:e}),r=De("storage");return r&&Xt(s,...r),s}function Xt(t,e,n,s={}){Gt(t,e,n,s)}function Vt(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new ne(n,s,r,e,Ie)}function Wt(){Pe(new Ce(Ne,Vt,"PUBLIC").setMultipleInstances(!0)),se(ue,ce,""),se(ue,ce,"esm2017")}Wt();export{Qt as a,Yt as g,Jt as r,Zt as u};
//# sourceMappingURL=firebase-storage-CQ6stn4o.js.map
